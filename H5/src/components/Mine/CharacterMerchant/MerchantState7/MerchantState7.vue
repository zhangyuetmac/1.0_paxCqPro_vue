<template>
  <div class="MerchantState7">
    <MerchantState7Header></MerchantState7Header>
    <ul class="main">
      <li class="normalLi" @click="goMyMerchantPage">
        ...
        <div class="right">
          <!-- <img src="../image/icon_warn.png"/> -->
          <img src="../../image/btn_more2.png" />
        </div>
      </li>
      <li class="normalLi" @click="goMyAgentPage">
        <div class="left">
          <a>我的代理商</a>
        </div>
        <div class="right">
      ...
      <!-- <li class="normalLi" @click="goExitLogin">
        <div class="left">
          <a>退出登录</a>
        </div>
        <div class="right">
...
<script>
import MerchantState7Header from "./MerchantState7Header";
import { Toast } from "vant";
import axios from "axios";
export default {
  components: {
    MerchantState7Header
  },
  data() {
    return {
      mainBackground: {
