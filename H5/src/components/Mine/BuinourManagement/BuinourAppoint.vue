  ...
  <div class="transitionWrapper">
    <div class="head">
      ...
      <div class="stepWrap">
        ...
        <div class="stepTitle">
          <div :class="[haveFill>=1?'active':'']">选择门店</div>
          <div :class="[haveFill>=2?'active':'']">委任店长</div>
        </div>
      </div>
    </div>
    <div class="main">
      <div class="title" v-if="haveFill=='1'">请选择委任的门店</div>
      <div class="title" v-if="haveFill=='2'&flag=='1'">请选择店长</div>
      <div class="mainTop" ref="mainTopWrapperBuinour">
        <ul class="mainTopUl" v-if="haveFill=='1'">
          <!-- <li v-if="haveFill=='1'"> 
           
           <mt-cell title="门店1" @click="jump" is-link></mt-cell>
            
          </li>-->
          <!-- <li class="shopList">
            <div class="shopContent" @click="jump">
              <div>门店1</div>
              <div class="btn-wrap">
        ...
        <ul class="mainTopUl2" v-if="haveFill=='2'">
          <!-- <li class="shopList2">
            <div class="shopContent2 active" @click="jump">
              <img src="./../image/img_shop-manager.png"/>
              <div class="info">
                <span class="num">工号01</span>
                <span class="name">张三</span>
              </div>
              <img class="choose" src="./../image/icon_label.png"/>
            </div>             
          </li>-->
          <li class="shopList2" v-if="flag=='1'" v-for="(item,index) in buinourList" :key="index">
            <div
              class="shopContent2"
              :class="[selBuinour==item.id?'active':'']"
              @click="change(item.id)"
            >
              <img src="./../image/img_shop-manager.png" />
              <div class="info">
                <span class="num">工号 {{item.id}}</span>
                <span class="name">{{item.name}}</span>
              </div>
              <img v-if="selBuinour==item.id" class="choose" src="./../image/icon_label.png" />
            </div>
          </li>
          <li v-if="flag=='2'" class="noPerson">
            <!-- 无员工 -->

            <div class="imageWrap staffBg"></div>
            <div class="info">该门店暂无员工</div>
            <div class="info">
              你可以去
              <span @click="add()">新增员工</span>
            </div>
          </li>
          <li v-if="flag=='3'" class="noPerson">
            <!-- 无需店长 -->

            <div class="imageWrap buinourBg"></div>
            <div class="info">该暂无门店需要委任店长</div>
          </li>
        </ul>
      </div>
      <div class="bottomBtn" v-if="haveFill=='2'&flag=='1'">
        <!-- <button type=button :class="[clickFlag1?'btn':'btnLight']" v-if="haveFill=='1'"  :disabled='clickFlag1'  @click="goStep2">下一步</button> -->

        <button
          type="button"
          :class="[clickFlag1?'btn':'btnLight']"
          v-if="haveFill=='2'"
          :disabled="clickFlag1"
          @click="send"
        >确定</button>
        ...
        li {
          ...
          &.noPerson {
            ...
            .imageWrap {
              ...
              &.staffBg {
                bg-image('./../image/img_no-staff');
              }

              &.buinourBg {
                bg-image('./../image/img_salesroom');
              }
            }
