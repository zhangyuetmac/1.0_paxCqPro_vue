<template>
  <div class="Organization">
    ...
    <ul class="main">
      ...
      <li class="normalLi" @click="goToRepairManagement">
        <div class="left">
          <a>保修管理</a>
        </div>
        <div class="right">
      ...
      <li class="normalLi" @click="goToMessageNotify">
        <div class="left">
          <a>消息通知</a>
        </div>
        <div class="right">
...
export default {
  ...
  methods: {
    ...
    //消息通知
    goToMessageNotify() {
      this.$router.push({ path: "/MessageNotify" });
    },
    //报修管理
    goToRepairManagement() {
      this.$router.push({ path: "/RepairManagement" });
    },
    //去用户演示界面
    goNewUserGuidePage() {
