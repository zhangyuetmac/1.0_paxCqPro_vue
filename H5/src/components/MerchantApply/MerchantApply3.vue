    ...
    <div class="main">
      <div class="mainTop" ref="mainTopWrapper">
        <ul class="mainTopUl">
          ...
          <li v-if="accountType==='对公'" class="inputLi">
            <a>企业开户许可证</a>
            <input class="myInput" type="text" placeholder="点击输入许可证号"   v-model="merchantApply3.accountname"></input>
          </li>
          <li v-if="accountType==='对公'" class="inputLi">
            <a>开户人姓名</a>
            <input class="myInput" type="text" placeholder="点击输入开户人姓名"   v-model="merchantApply3.accountname"></input>
          </li>
          <li v-if="accountType==='对公'" class="inputLi">
            <a>开户省份和城市</a>
            <div @click="toastArea">
          ...
          <li class="inputLi">
            <a>开户人</a>
            <input class="myInput" type="text" placeholder="点击输入开户人"   v-model="merchantApply3.accountname"></input>
          </li>
          <li class="inputLi">
            <a>开户银行</a>
            <input class="myInput" type="text" placeholder="点击输入开户银行"   v-model="merchantApply3.bankname"></input>
          </li>
          <li class="inputLi">
            <a>开户支行</a>
            <input class="myInput" type="text" placeholder="点击输入开户支行"   v-model="merchantApply3.sub_bank_name"></input>
          </li>
          <li class="inputLi">
            <a>银行账号</a>
            <input class="myInput" type="text" placeholder="点击输入账号"   v-model="merchantApply3.account_code"></input>
          </li>
          
          <li class="inputLi borderNone">
            <a>预留手机号</a>
            <input class="myInput" type="text" placeholder="点击输入手机号"   v-model="merchantApply3.tel"></input>
          </li>
          <li style="background:#F8F8FA;height:10px;width:100%"></li>
          <li v-if="accountType==='对私授权人'"  class="IdCardLiFirst">
          ...
          <li v-if="accountType==='对私授权人'"  class="inputLi" >
            <a>起始有效期</a>
          ...
          <li style="background:#F8F8FA;height:10px;width:100%"></li>
          <li v-if="accountType==='对私法人' || accountType==='对私授权人'" class="IdCardLi">
            <div class="IdCardText">
              <a>银行卡照片</a>
            </div>
            <div class="IdCardWrapper">
          ...
          <li style="background:#F8F8FA;height:10px;width:100%"></li>
          <li v-if="$store.state.photoType === '2'" class="IdCardLi">
            <div class="IdCardText">
              <a>护照照片</a>
            </div>
            <div class="IdCardWrapper">
